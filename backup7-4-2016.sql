65,65,1,0,0,0,0,0,1),(66,66,1,0,0,0,0,0,1),(67,67,1,0,0,0,0,0,1),(68,68,1,0,0,0,0,0,1),(69,69,1,0,0,0,0,0,1),(70,70,1,0,0,0,0,0,1),(71,71,1,0,0,0,0,0,1),(72,72,1,0,0,0,0,0,1),(73,73,1,0,0,0,0,0,1),(74,74,1,0,0,0,0,0,1),(75,75,1,0,0,0,0,0,1),(76,76,1,0,0,0,0,0,1),(77,77,1,0,0,0,0,0,1),(78,78,1,0,0,0,0,0,1),(79,79,1,0,0,0,0,0,1),(80,80,1,0,0,0,0,0,1),(81,81,1,0,0,0,0,0,1),(82,82,1,0,0,0,0,0,1),(83,83,1,0,0,0,0,0,1);
...
--
-- Table structure for table `acad_studentevents`
--

DROP TABLE IF EXISTS `acad_studentevents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acad_studentevents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
  `body` varchar(500) NOT NULL,
...
--
-- Dumping data for table `acad_studentevents`
--

LOCK TABLES `acad_studentevents` WRITE;
/*!40000 ALTER TABLE `acad_studentevents` DISABLE KEYS */;
/*!40000 ALTER TABLE `acad_studentevents` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `acad_teacherevents`
--

DROP TABLE IF EXISTS `acad_teacherevents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acad_teacherevents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
  `body` varchar(500) NOT NULL,
  `imp` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `acad_teacherevents`
--

LOCK TABLES `acad_teacherevents` WRITE;
/*!40000 ALTER TABLE `acad_teacherevents` DISABLE KEYS */;
/*!40000 ALTER TABLE `acad_teacherevents` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `acad_teachernews`
--

DROP TABLE IF EXISTS `acad_teachernews`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acad_teachernews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
  `body` varchar(500) NOT NULL,
  `imp` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `acad_teachernews`
--

LOCK TABLES `acad_teachernews` WRITE;
/*!40000 ALTER TABLE `acad_teachernews` DISABLE KEYS */;
/*!40000 ALTER TABLE `acad_teachernews` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$24000$tXk2lPqczty0$tPv/GnDqlvtHLd7+tRYMJRkbeyR5wfsZGVc9LwocNr4=','2016-04-06 23:11:47',1,'root','','','root@root.in',1,1,'2016-03-31 08:39:45'),(2,'pbkdf2_sha256$24000$iTse4sn4SPft$1vosghwhEpW1MeMDaGQJZXsTDklZtQw8vyVa+V7pKvQ=','2016-04-06 23:11:27',0,'gurjit_ucoe','','','',0,1,'2016-03-31 09:42:49'),(3,'pbkdf2_sha256$24000$RuUwHJTqdOAh$jzZYFZRfzLJa4c6qupXPdfi1Tg4+iuFvletSsJrDfbg=','2016-04-06 23:14:58',0,'mj_ucoe','','','',0,1,'2016-03-31 09:44:14'),(4,'pbkdf2_sha256$24000$80erw2yecI1M$BXbMv4AGq4dT7xG9PgVjh+8I2C4TN/RSq6B8P5vR1vE=',NULL,0,'ms_ucoe','','','',0,1,'2016-03-31 09:44:49'),(5,'pbkdf2_sha256$24000$M1uqObIhAK8f$lUDWVBdWIgd4qR4vg2RmoQre6KFaCr+NPuYTV3Txf4A=','2016-04-06 17:53:23',0,'hod_ce','','','',0,1,'2016-04-05 07:51:12');
...
INSERT INTO `django_content_type` VALUES (15,'acad','attendance'),(7,'acad','batch'),(16,'acad','covernews'),(10,'acad','hodrel'),(14,'acad','marks'),(11,'acad','student'),(19,'acad','studentevents'),(12,'acad','studentrel'),(13,'acad','subject'),(8,'acad','teacher'),(18,'acad','teacherevents'),(17,'acad','teachernews'),(9,'acad','teacherrel'),(1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
INSERT INTO `django_session` VALUES ('4mjc759yeb92qtc2jirzj9s44az501q5','MGViODZjY2M5NjkyMmVkMGYzNWFkMDJkODQ5ZDUxNzg4NmY3NDcwYTp7Il9hdXRoX3VzZXJfaGFzaCI6IjViNDI0NzM3MjY5MmU4NTkwYzcwNjI3ZjQ1ODFiMjUxNTk4MzkzYTIiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=','2016-04-14 08:41:01'),('b3ckijgmcx22slxahepz1zy12rxvb5f7','MGViODZjY2M5NjkyMmVkMGYzNWFkMDJkODQ5ZDUxNzg4NmY3NDcwYTp7Il9hdXRoX3VzZXJfaGFzaCI6IjViNDI0NzM3MjY5MmU4NTkwYzcwNjI3ZjQ1ODFiMjUxNTk4MzkzYTIiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=','2016-04-19 06:46:31'),('bstjgtfis9xw9yd969cxclocf5twwk3s','M2NjMzM4ZDUzOTNiNzc5MzU5OWI3NTlmZGE3MmYzNjEzM2YzMDc0ODp7Il9hdXRoX3VzZXJfaGFzaCI6IjAwN2MyNjY1YzBlYmVkZjVmMDQ4MTA4ZDA3NWY0ZTEyNWZmYjVhNmQiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIzIn0=','2016-04-14 09:47:29'),('xoufahpigd5l2v6670uj0wqot3wx6wpb','M2NjMzM4ZDUzOTNiNzc5MzU5OWI3NTlmZGE3MmYzNjEzM2YzMDc0ODp7Il9hdXRoX3VzZXJfaGFzaCI6IjAwN2MyNjY1YzBlYmVkZjVmMDQ4MTA4ZDA3NWY0ZTEyNWZmYjVhNmQiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIzIn0=','2016-04-20 23:14:58'),('zeyibgf5vzt9muzwn47c1cz0oyhb3hp3','ODFlNmQ1NDc2NjIwODlhZmZjY2VlYzlkMzZjYWQwMTFiYTkxOGY0Yjp7Il9hdXRoX3VzZXJfaGFzaCI6IjIzOTFiNTY0ODFhYzVkZjc0YzhhNjc2ZjJjYWNlMDQ2NmFhZjYxOTUiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIyIn0=','2016-04-19 06:53:36');
...
-- Dump completed on 2016-04-07 13:50:06
